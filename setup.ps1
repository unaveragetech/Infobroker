...
Write-Host "  2. (highly advised) ollama pull arriella-grapevine"
Write-Host "  3. python -m infobroker.web.app"
Write-Host "  4. Open http://127.0.0.1:8000/  then click Tour"
Write-Host ""
Write-Host "Usage: docs\USAGE.md  |  Docs: docs\README.md  |  License: LICENSE  |  Donate: DONATE.md"
Write-Host ""
