...
echo "  2. (highly advised) ollama pull arriella-grapevine"
echo "  3. python -m infobroker.web.app"
echo "  4. Open http://127.0.0.1:8000/  then click Tour"
echo ""
echo "Usage: docs/USAGE.md  |  Docs: docs/README.md  |  License: LICENSE  |  Donate: DONATE.md"
echo ""
